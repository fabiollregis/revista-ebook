  ...
  return (
    ...
    >
      <header className="bg-white/80 dark:bg-background/80 backdrop-blur-md shadow-sm py-4 sticky top-0 z-10">
        <div className="container mx-auto px-4 flex justify-between items-center">
          <motion.div variants={itemVariants}>
            <h1 className="text-2xl font-bold bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent">Venice Guide</h1>
          </motion.div>
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        <motion.div 
          className="w-full h-[70vh] rounded-xl overflow-hidden magazine-card border-2 border-primary/20"
      ...
      <motion.footer 
        className="bg-white/80 dark:bg-background/80 backdrop-blur-md py-6 border-t border-border"
        variants={itemVariants}
      >
